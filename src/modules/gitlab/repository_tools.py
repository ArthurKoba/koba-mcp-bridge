...
def register_gitlab_repository_tools(
    ...
    def get_file(
        ...
        return client_factory(profile_id).get_file(project, path, ref)
    ...
    def list_tree(
        ...
        return client_factory(profile_id).list_tree(
    ...
    def search_code(
        ...
        return client_factory(profile_id).search_code(project, search, ref, page, per_page)
    ...
    def put_file(
        ...
        return client_factory(profile_id).put_file(
    ...
    def delete_file(
        ...
        return client_factory(profile_id).delete_file(
    ...
    def commit_actions(
        ...
        return client_factory(profile_id).commit_actions(
    ...
    def list_branches(
        ...
        return client_factory(profile_id).list_branches(project, search, page, per_page)
    ...
    def create_branch(
        ...
        return client_factory(profile_id).create_branch(project, branch, ref)
    ...
    def delete_branch(
        ...
        return client_factory(profile_id).delete_branch(project, branch)
    ...
    def compare(
        ...
        return client_factory(profile_id).compare(project, from_ref, to_ref, straight)
