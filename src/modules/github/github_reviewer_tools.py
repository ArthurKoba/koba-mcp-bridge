...
def register_github_reviewer_tools(
    ...
    def github_reviewer_list_repositories() -> JsonObject:
    ...
    def github_reviewer_status(repository: str) -> JsonObject:
    ...
    def github_reviewer_list_branches(repository: str) -> JsonObject:
    ...
    def github_reviewer_get_commit(repository: str, ref: str) -> JsonObject:
    ...
    def github_reviewer_check_runs(repository: str, ref: str) -> JsonObject:
